...
ex_1_1 = md"""
Considering $a_{n+1} = \frac{1}{2} (\frac{x}{a_n} + a_n)$, if $a_n$ is too big ($> \sqrt{x}$), then $\frac{x}{a_n}$ will be too small ($< \sqrt(x)$). In this way, their average, $a_{n+1}$, will be closer to $\sqrt{x}$.

$\frac{1}{2}(\frac{x}{\sqrt{x}} + \sqrt{x}) = \sqrt{x}$
...
# ╔═╡ 9b82916e-feb5-11ea-210b-19da72c4aa6b
abs(newton_sqrt(2) - sqrt(2))
